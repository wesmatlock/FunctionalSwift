...
public func curry<A, B, C, D, Output>(_ transform: @escaping (A, B, C, D) -> Output) -> (A) -> (B) -> (C) -> (D) -> Output {
  return { a in { b in { c in { d in transform(a,b,c,d) } } } }
}

public func curry<A, B, C, D, E, Output>(_ transform: @escaping (A, B, C, D, E) -> Output) -> (A) -> (B) -> (C) -> (D)
-> (E) -> Output {
  return { a in { b in { c in { d in { e in transform(a,b,c,d, e) } } } } }
}

public func curry<A, B, C, D, E, F, Output>(_ transform: @escaping (A, B, C, D, E, F) -> Output) -> (A) -> (B) -> (C) -> (D)
-> (E) -> (F) -> Output {
  return { a in { b in { c in { d in { e in { f in transform(a,b,c,d,e,f) } } } } } }
}

public func curry<A, B, C, D, E, F, G, Output>(_ transform: @escaping (A, B, C, D, E, F, G) -> Output) -> (A) -> (B) -> (C)
-> (D) -> (E) -> (F) -> (G) ->  Output {
  return { a in { b in { c in { d in { e in { f in { g in transform(a,b,c,d,e,f,g) }  } } } } } }
}

public func curry<A, B, C, D, E, F, G, H, Output>(_ transform: @escaping (A, B, C, D, E, F, G, H) -> Output) -> (A) -> (B)
-> (C) -> (D) -> (E) -> (F) -> (G) -> (H) ->  Output {
